<?php require_once '../admin/controllers/settings/generalSetConnect.php';?>
<?php require_once '../admin/controllers/about/aboutConnect.php'?>

<!DOCTYPE html>
<html lang="az">
<head>
    <meta charset="UTF-8">
    <meta name="description" content="<?= $connect['set_desc']?>">
    <meta name="keywords" content="<?= $connect['set_keywords']?>">
    <meta name="author" content="<?= $connect['set_author']?>">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?= $connect['set_title']?></title>
