        ...
        <div class="row">
            ...
            <div class="col-md-4"><!--footer contact widget-->
                ...
                <ul class="contact-widget">
                    <li class="fphone"><?= $connect['set_tel']?></li>
                    <li class="fmobile"><?= $connect['set_mobile']?></li>
                    <li class="fmail lastone"><?= $connect['set_mail']?>></li>
                </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="f-credit">&copy; <?= $connect['set_footer']?> <a href="<?= $connect['set_site_name']?>"><?= $connect['set_title']?></a></div>
            ...
            <div class="col-md-3"><!--footer Share-->
                ...
                <div class="fsoc">
                    <a href="<?= $connect['set_fb']?>" target="_blank" class="ffacebook">facebook</a>
                    <a href="<?= $connect['set_tw']?>" target="_blank" class="ftwitter">twitter</a>
                    <a href="<?= $connect['set_yt']?>" target="_blank"><i class="fab fa-facebook"></i></a>
                    <div class="clearfix"></div>
                </div>
                <div class="clearfix"></div>
            </div><!--footer Share-->
